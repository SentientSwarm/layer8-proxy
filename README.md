...
**Current version: v1.2.0** ([release notes](https://github.com/SentientSwarm/layer8-proxy/releases/tag/v1.2.0))

## Components

- **locksmith** ([`agent-locksmith`](https://github.com/SentientSwarm/agent-locksmith) v2.2.0)
...
|---|---|---|
| v1.2.0 | v2.2.0 | + Phase G2: codex `ChatGPT-Account-ID` auto-injection. **Current.** |
